		...
		value: function render() {
			...
			if (this.props.value == "tab") {
				return _react2.default.createElement(
					'button',
					{ className: 'keyboard-button' + ' ' + this.props.classes, 'data-en': this.props.en, 'data-fr': this.props.fr, onClick: function onClick() {
							return _this2.handleTab();
						} },
					'Tab'
				);
			}
			...
			return _react2.default.createElement(
				'button',
				{ className: 'keyboard-button' + ' ' + this.props.classes, 'data-en': this.props.en, 'data-fr': this.props.fr, onClick: this.handleClick },
				this.props.value
			);
		}
	}]);
...
KeyboardButton.propTypes = {
	...
	en: _react.PropTypes.string,
	fr: _react.PropTypes.string,
