...
var Keyboard = function (_PureComponent) {
	...
	_createClass(Keyboard, [{
		...
		value: function handleLetterButtonClick(key) {
			...
			var _inputNode$ = inputNode[0],
			    value = _inputNode$.value,
			    selectionStart = _inputNode$.selectionStart,
			    selectionEnd = _inputNode$.selectionEnd;
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					true ? _react2.default.createElement(_KeyboardButton2.default, {
						value: '@',
